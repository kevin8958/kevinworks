...
export default function Section4() {
  return (
    <section className="relative flex w-full flex-col items-center gap-10 px-6 pt-20 pb-20 lg:px-10">
      <div className="bg-primary-900 flex h-[300px] h-full w-full max-w-[1000px] flex-col items-center justify-center gap-4 overflow-hidden rounded-2xl px-4 py-10 text-center">
        ...
        <a
          ...
          className="border-primary-200/30 hover:bg-primary-800 mt-4 rounded-2xl border px-4 py-2 text-lg transition-colors"
        >
          kevin8958@gmail.com
        </a>
      </div>
