...
const ButtonGroup = (props: Common.ButtonGroupProps) => {
  ...
  return (
    <FlexWrapper items="center" justify="center" gap={2}>
      ...
      <FlexWrapper
        classes={classNames(
          'shrink-0 rounded-lg p-1 shadow-custom-dark bg-primary-800',
          classes,
        )}
        items="center"
        justify="center"
        ...
        {options.map((option) => (
          <button
            ...
            className={classNames(
              '!border-0 !px-2 !py-[4px] !text-sm rounded-md text-primary-300 transition-all duration-200 ease-in-out',
