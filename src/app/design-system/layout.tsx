    ...
    <PageWrapper>
      <div className="flex min-h-[calc(100dvh-60px)] w-full flex-col">
        <div className="relative w-full">
          <div className="from-neutral-990 to-neutral-990/30 fixed top-0 left-0 z-[999] flex w-full items-center justify-between bg-gradient-to-b from-60% to-100% px-6 pt-8 pb-6 sm:justify-end">
